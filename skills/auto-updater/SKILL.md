...
## Custom Configuration (Daily Notifications)

This installation has been configured for **daily summary reports** with the following settings:

| Setting | Value | Description |
|---------|-------|-------------|
| Schedule | `0 3 * * *` | Daily at 3:00 AM IST |
| Timezone | Asia/Kolkata | IST (UTC+5:30) |
| Daily Report | ✅ Enabled | Full summary every day |
| Notify on Failure | ✅ Enabled | Error details included |
| Backup Before Update | ✅ Enabled | Skills backed up before major updates |

### Configuration Files

- **Cron Job**: System crontab (`crontab -l`)
- **Script**: `/home/ubuntu/clawd/skills/auto-updater/scripts/auto-update.py`
- **Config**: `/home/ubuntu/clawd/skills/auto-updater/config.json`
- **Logs**: `~/.clawdbot/auto-update.log`
- **Backups**: `~/.clawdbot/backups/skills_backup_*.tar.gz`

### Daily Report Format

Every day at 3 AM IST, you'll receive:
...
💾 Backup: ~/.clawdbot/backups/skills_backup_20260129_030045.tar.gz
```

### Manual Testing

Test the auto-updater manually:
```bash
python3 /home/ubuntu/clawd/skills/auto-updater/scripts/auto-update.py
```

View logs:
```bash
tail -f ~/.clawdbot/auto-update.log
```
